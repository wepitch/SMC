...
class FollowerUpdateScreen extends StatelessWidget {
  // final String counselorId = '656d6161b3dd227646f585ff';
            ...
            body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      followerProvider.updateFollowers(FollowerModel());
                    },
                    child: followerProvider.isFollowing ? Text('Unfollow') : Text('Follow'),
                  ),
                ],
              ),
            ),
