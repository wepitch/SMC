                          ...
                          children: [
                            ...
                            Text(
                              '\u{20B9}${counsellorDetailController
                                  .checkOutDetailsList.isNotEmpty
                                  ? counsellorDetailController
                                  .checkOutDetailsList[0].gatewayCharge ?? "N/A"
                                  : "N/A"}',
                              style: TextStyle(
                                color: ColorsConst.black54Color,
                                fontSize: 13,
                          ...
                          children: [
                            ...
                            Text(
                              '\u{20B9}${counsellorDetailController
                                  .checkOutDetailsList.isNotEmpty
                                  ? counsellorDetailController
                                  .checkOutDetailsList[0].totalAmount ?? "N/A"
                                  : "N/A"}',
                              style: TextStyle(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              var value_res = await ApiService
                                  .bookValidationSession(sessionId);
                              if (value_res.containsKey("message"))
                              {
                                ...
                                var value = await ApiService.counsellor_create_order(
                                    widget.name,
                                    'abc@gmail.com',
                                    counsellorDetailController
